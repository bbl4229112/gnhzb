...
<script src="${ctx}/js/knowledge/knowledge-util.js" type="text/javascript"></script>
<script src="${ctx}/js/interestmodel/interestmodellist.js" type="text/javascript"></script>

<script type="text/javascript">
new knowledgeSubscribeList();
