...
<script src="../js/knowledge/knowledge_batchupload.js" type="text/javascript"></script>
									...
									<tr>
										<td>
											...
											<!--<div  id='selTemplate'>
                                       		...
                                       		-->
											<div id='uploadfile'>
												<s:form id="knowledgeuplod" action="knowledge!batchsave.action" 
													...
													<s:hidden name="ktypenamestring" id="ktypenamestring" />
...
cims201.knowledge.batchUploadknowledgeInit(x);
