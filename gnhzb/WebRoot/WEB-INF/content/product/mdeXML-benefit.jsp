...
<HTML>
	...
	<BODY>
		<%
				...
				String strXML = "";
				strXML += "<graph caption='产品2相对于产品1模块化效益评价各指标变化比例(%)' showNames='1'  decimalPrecision='0' decimals='2'  baseFontSize='13' numberSuffix=''>";
                List<String> ln = (List<String>)request.getAttribute("listname");
		        List<Float> lv = (List<Float>)request.getAttribute("listvalue");
		
		        for(int i=0;i<ln.size();i++){
			       if(lv.get(i) != 0)
			       	strXML += "<set name='"+ln.get(i)+"' value='"+lv.get(i)*100+"' color='"+ac[10-i]+"'/>";
		        }
