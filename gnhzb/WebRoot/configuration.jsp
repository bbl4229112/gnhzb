        	...
        	{	id:'navBtns',
                ...
                children:[         
	               ...
	               
	                {
	                    ...
	                    type: 'label', height:76, style: 'padding-left:2px; padding-right:2px;padding-top:5px;', text: '<a href="http://localhost:8080/gnhzb/user.jsp"><div class="cims201_topbar_icon">&nbsp;<image height=45 width=45 src=css/images/home2.png><br>&nbsp;系统主页</div></a>'
	               ...
	               //     type: 'label', height:76, style: 'padding-left:2px; padding-right:2px;padding-top:5px;', text: '<a href="http://10.11.112.71:8080/lgpdm/"/*javascript:navManager("patent");*/><div class="cims201_topbar_icon">&nbsp;<img style=height:45px  src=css/images/myquestionlist.gif><br>&nbsp;测试</div></a>'
		            ...
		            //右主界面
                	{
		                ...
		                children:[
							...
							},
							{
								...
								children: [								    
								    //{type: 'label', text: 'abc'}
								    //cims201_indexPage.getResourceIndex()
