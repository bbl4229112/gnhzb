...
<html>
  <head>
    ...
    <title>My JSP 'CodeClassRuleManage.jsp' starting page</title>
  ...
  <body id="CodeClassRuleManageBody">
  </body >
  <script src="<%=basePath %>cqz/edojs/scripts/edo/edo.js" type="text/javascript"></script>
  <script src="<%=basePath %>cqz/js/module/testRightMenu.js" type="text/javascript"></script>
</html>
