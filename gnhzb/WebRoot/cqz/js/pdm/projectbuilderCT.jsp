...
<html>
	...
	<div id="builder"
		...
		<iframe id="aa" height= 100%  width=100%  src="<%=basePath%>cqz/js/pdm/projectbuilder.jsp"></iframe>
	</div>
    ...
    var a=document.getElementById('processdefineContainer');
