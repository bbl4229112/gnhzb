...
<head>
	...
	<link rel="stylesheet" type="text/css"
		...
		<script src="<%=basePath%>js/lca/lca_projectdefine.js" type="text/javascript"></script>
	...
	/* 	'<div style=" text-align: center;padding:0px 0px 0px 0px;width:120px;background:#41B9F5;height:50px;opacity:100">'+
		...
		var graph = editor.graph;
				...
				var data= cims201.utils.getData('http://localhost:8080/Myproject20140827/module/module!getfunctionsbyprocessid.action',{moduleid:moduleid,processid:processid});
				if (data){
				cell.isNode=true;
				}
				cell.data=data;
				...
				var data= cims201.utils.getData('http://localhost:8080/Myproject20140827/project/project!saveproject.action',{projectobjectdefine:projectobjectdefine,cellcollection:cellcollection
		});
	 			/* var data= cims201.utils.getData('http://localhost:8080/Myproject20140827/project/project!saveproject.action',{projectdetail:projectdetail,cellcollection:cellcollection,projectname:projectname,starttime:starttime,
	     ...
	     {type: 'button', text: '新增', arrowMode: 'menu',
	            menu: [
	                {type: 'button', text: 'PDM项目',onclick: function(e){
	                	new projectdefine('PDM');
	                }
                	},
                	{type: 'button', text: 'LCA项目',onclick: function(e){
	                	new projectdefine('LCA');
	                }
                	},
	            ]
	        },                        
	...
	/* 	document.oncontextmenu = function(){
		...
		function getmodulebyid(graph,moduleid){
			...
			graph.getModel().beginUpdate();
				try
				{	
					read(graph,"http://localhost:8080/Myproject20140827/module/module!downloadXML.action?moduleid="+moduleid);	
				}
				finally
				{
					// Updates the display
