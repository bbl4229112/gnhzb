...
<head>
	...
	/* 	'<div style=" text-align: center;padding:0px 0px 0px 0px;width:120px;background:#41B9F5;height:50px;opacity:100">'+
		...
		var graph = editor.graph;
				...
				var data= cims201.utils.getData('http://localhost:8080/Myproject20140827/task/task!taskAssignment.action',{moduleid:moduleid,taskid:taskid,cellcollection:cellcollection
		});
		...
		var moduledata= cims201.utils.getData('http://localhost:8080/Myproject20140827/module/module!getModuletree.action',{moduletype:'PDM'});
