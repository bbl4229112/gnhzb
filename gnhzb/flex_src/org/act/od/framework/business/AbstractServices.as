package org.act.od.framework.business{
   ...
   public class AbstractServices implements IServices
   {
      ...
      {
         throw new OrDesignerError( OrDesignerMessageCodes.ABSTRACT_METHOD_CALLED, "register" );
      }
      ...
      {
         throw new OrDesignerError( OrDesignerMessageCodes.ABSTRACT_METHOD_CALLED, "getService" );
      }
      ...
      {
         throw new OrDesignerError( OrDesignerMessageCodes.ABSTRACT_METHOD_CALLED, "setCredentials" );
      }
      ...
      {
         throw new OrDesignerError( OrDesignerMessageCodes.ABSTRACT_METHOD_CALLED, "setRemoteCredentials" );
      }
      ...
      {
         throw new OrDesignerError( OrDesignerMessageCodes.ABSTRACT_METHOD_CALLED, "logout" );
      }
