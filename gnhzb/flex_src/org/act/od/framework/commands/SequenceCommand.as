package org.act.od.framework.commands{
   ...
   import org.act.od.framework.control.OrDesignerEventDispatcher;
    ...
    */
   public class SequenceCommand implements IODCommand{      
      /**
       * The next event in the sequence.
       */
      public var nextEvent : OrDesignerEvent;       
       
       /**
       * Constructor, with optional nextEvent.
       */
      public function SequenceCommand( nextEvent : OrDesignerEvent = null ) : void{
      ...
      public function executeNextCommand() : void{
         ...
         if( isSequenceCommand )
            OrDesignerEventDispatcher.getInstance().dispatchEvent( nextEvent );
      }
