package org.act.od.framework.control{
    ...
    */
   public class OrDesignerEvent extends Event{
       ...
       */
      public function OrDesignerEvent( type : String, dataParamter:Object = null ,
      ...
      public function dispatch() : Boolean{
         return OrDesignerEventDispatcher.getInstance().dispatchEvent( this );
      }
   }
}