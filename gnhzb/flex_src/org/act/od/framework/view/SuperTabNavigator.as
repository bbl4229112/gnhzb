...
package org.act.od.framework.view
{
	...
	import org.act.od.framework.view.ScrollableArrowMenu;
	import org.act.od.framework.view.SuperTabBar;
	import org.act.od.framework.view.SuperTab;
	import org.act.od.framework.view.SuperTabEvent;
	import org.act.od.framework.view.TabReorderEvent;
	import org.act.od.framework.view.TabPopUpButtonSkin;
	...
	public class SuperTabNavigator extends TabNavigator
	{
		...
		[Embed(source="../libs/assets.swf", symbol="indicator")]
		private static var DEFAULT_INDICATOR:Class;
		
		[Embed(source="../libs/assets.swf", symbol="firefox_close_up")]
		private static var DEFAULT_CLOSE_UP:Class;
		
		[Embed(source="../libs/assets.swf", symbol="firefox_close_over")]
		private static var DEFAULT_CLOSE_OVER:Class;
		
		[Embed(source="../libs/assets.swf", symbol="firefox_close_down")]
		private static var DEFAULT_CLOSE_DOWN:Class;
		
		[Embed(source="../libs/assets.swf", symbol="firefox_close_disabled")]
		private static var DEFAULT_CLOSE_DISABLED:Class;
		
		[Embed(source="../libs/assets.swf", symbol="left_arrow")]
		private static var DEFAULT_LEFT_BUTTON:Class;
		
		[Embed(source="../libs/assets.swf", symbol="right_arrow")]
