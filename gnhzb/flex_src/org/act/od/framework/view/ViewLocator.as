package org.act.od.framework.view{
   ...
   public class ViewLocator
   {
      ...
      public function ViewLocator()
      {
         ...
         {
            throw new OrDesignerError(
               OrDesignerMessageCodes.SINGLETON_EXCEPTION, "ViewLocator" );
         }
      ...
      public function register( viewName : String, viewHelper : ViewHelper ) : void
      {
         ...
         {
            throw new OrDesignerError(
               OrDesignerMessageCodes.VIEW_ALREADY_REGISTERED, viewName );
         }
      ...
      public function unregister( viewName : String ) : void
      {
         ...
         {
            throw new OrDesignerError(
               OrDesignerMessageCodes.VIEW_NOT_FOUND, viewName );
         }
