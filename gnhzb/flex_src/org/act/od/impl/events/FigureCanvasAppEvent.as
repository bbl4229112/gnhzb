package org.act.od.impl.events
{
	...
	public class FigureCanvasAppEvent extends OrDesignerEvent{
		/**
		 * Change the MicroImageNode canvas
		 * @Author Litao
		 * @Date 20120809
		 */
		public static const Canvas_Node_Selected :String = "canvas_node_selected";
		/**
		...
		/**
		 * Move figures in the canvas.
		 */
		public static const FIGURE_MOVE_IN_CANVAS :String = "figure_move_in_canvas";
		/**
		...
		/**
		 *create Message Flow connector link  (Bpmn view)
		 */
		public static const Node_Create_MessageFlow_Link :String = "node_create_message_flow_link";
		...
		/**
		 * Clic in abstruct pool.
		 */
		public static const POOL_CLIC : String = "pool_clic";
		
		/**
		 * Refresh the figureEditorCanvas.
		 */
		public static const RE_FRESH : String = "re_fresh";		
		
		/**
		 * Draw Sign on Figures.
		 */
		public static const DRAW_SIGN_ON_FIGURES : String = "draw_sign_on_figures";		
