package org.act.od.impl.figure
{
	...
	public class ProcessFigure implements IFigure
	{
		...
		public function readInformationToFigure(info:XML,rootFigureEditorModel:FigureEditorModel,fatherFigureEditorModel:FigureEditorModel):void{
			...
			if(fatherFigureEditorModel != null && fatherFigureEditorModel.sonModel.length == 0){
				if(info != null){
					...
					for(i=0;i<length;i++)
					{
						...
						fig.readInformationToFigure(XML(list[i]),rootFigureEditorModel,fatherFigureEditorModel);
