package org.act.od.impl.figure
{
	...
	public class RedLinkFigure extends ConnectionFigure
	{
		public function RedLinkFigure(processType:String = null)
		{
			super(processType);
			drawid=3;
			standardwidth=30;
		...
		override public function drawpicture():void
		{
			...
			//			!!!!!!!!!!!!!!!!!!!!!!!!!
			//change the color of the arrow : gray
			sprt.graphics.lineStyle(this.lineThickness,0xB6AFA9,1);
			sprt.graphics.lineStyle(2, 0xff0000, 1);
