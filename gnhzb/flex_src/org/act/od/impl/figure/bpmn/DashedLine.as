...
package org.act.od.impl.figure.bpmn
{
	...
	public class DashedLine extends Sprite
	{
		...
		public var fill:Shape = new Shape();	// shappe in the background to be used for fill (if any)
		public var stroke:Sprite ;	// shape in the foreground to be used for the dashed line
		
		public function DashedLine(sprite:Sprite, weight:Number = 0, color:Number = 0, lengthsArray:Array = null){
			...
			for (var i:int=0 ;i<this.lengthsArray.length; i++){
				arraySum += this.lengthsArray[i];
			}
