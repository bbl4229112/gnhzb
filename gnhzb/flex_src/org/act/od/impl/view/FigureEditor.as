package org.act.od.impl.view{
	...
	public class FigureEditor extends EditorNavigatorChild{
		...
		public  var _figureCanvas :FigureCanvas;
		 ...
		 */
		public function FigureEditor(filePath :String, fileName :String, feModel :FigureEditorModel, fileCategory)
		{
			...
			_bpmnFigureCanvas = new FigureCanvas(_bpmnFigureEditorModel, feModel.processType);
			
			_graphicalView = new HDividedBox();
			_graphicalView.percentHeight = 100;
			...
			_bpmnGraphicalView.percentHeight = 100;
...
//			_figureCanvas.label= localizator.getText('figureeditor.graphic');
			...
			_toolPanel = new ToolPanel(fileCategory);
...
//			_graphicalView.addChild(toolPanelTabNav);
			...
			viewStack.addChild(_figureCanvas);
//			viewStack.addChild(xmlHBox);
			...
			else if(feModel.processType == FigureEditorModel.BPMN_PROCESS_TYPE)
			{
				bpmnCanvas = _bpmnBpelTab.createTab("BPMN");
				this.addChild(bpmnViewStack);
				this.addChild(bpmnBox);
...
//			figureCanvas.updateFigure();
			...
			if( figureEditorModel.canvasXML != null ){
				...
				rootFig.readInformationToFigure(figureEditorModel.canvasXML,figureEditorModel.rootModel,figureEditorModel.fatherModel);
