...
public class ClassificationTreeAction extends ActionSupport implements ServletResponseAware{
	/**
	 * 
	 */
	...
	public String getClassStruct() throws IOException{
		List<ClassificationTree> treeList=classificationTreeService.getClassStruct();
	...
	public String getChildrenNode() throws IOException{
		List<ClassificationTree> treeList=classificationTreeService.getChildrenNode(pid);
		String treeStr =JSONUtil.write(treeList);
	...
	@Autowired
	public void setClassificationTreeService(ClassificationTreeServiceImpl classificationTreeService) {
