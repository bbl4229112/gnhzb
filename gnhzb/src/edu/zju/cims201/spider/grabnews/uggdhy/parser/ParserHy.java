package edu.zju.cims201.spider.grabnews.uggdhy.parser;
...
public class ParserHy implements edu.zju.cims201.spider.commontool.Parser{
    private String source;
    private Log log = LogFactory.getLog(this.getClass());
	public ParserHy(){
    	
    }
    public ParserHy(String source){
    	this.source = source;
    }
