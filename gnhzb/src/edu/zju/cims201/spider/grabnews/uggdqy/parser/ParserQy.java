package edu.zju.cims201.spider.grabnews.uggdqy.parser;
...
public class ParserQy implements edu.zju.cims201.spider.commontool.Parser{
    private String source;
    private Log log = LogFactory.getLog(this.getClass());
	public ParserQy(){
    	
    }
    public ParserQy(String source){
    	this.source = source;
    }
