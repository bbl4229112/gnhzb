...
import edu.zju.cims201.spider.grabnews.uggdrd.parser.ParserRD;
import edu.zju.cims201.spider.grabnews.uggdrd.rule.RDUrlRule;
 ...
 * 
 */
public class RDSpider extends Thread implements ISpiderReportable {
	private static final RDSpider m_bzwspider = new RDSpider();
	...
	protected static String _hostUrl = "http://www.uggd.com/news/rdnews/";
...
//			); 
	...
	protected RDUrlRule rule = new RDUrlRule();
	protected ParserRD parser = new ParserRD();
	private static String spidername = "BzwSpider";

	private static String tablename = "workload";

	private static String urlpattern = "http://www.uggd.com/news/rdnews/\\d{4,5}.html";

	private static String defaulturl = "http://www.uggd.com/news/rdnews/";  
	...
	public static RDSpider getInstance() {
		return m_bzwspider;
	}
	/*
	 * （非 Javadoc）
