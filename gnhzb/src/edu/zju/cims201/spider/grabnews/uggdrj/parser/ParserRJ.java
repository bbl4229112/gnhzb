package edu.zju.cims201.spider.grabnews.uggdrj.parser;
...
public class ParserRJ implements edu.zju.cims201.spider.commontool.Parser{
    private String source;
    private Log log = LogFactory.getLog(this.getClass());
	public ParserRJ(){
    	
    }
    public ParserRJ(String source){
    	this.source = source;
    }
