...
import edu.zju.cims201.spider.grabnews.uggdyj.parser.ParserYJ;
import edu.zju.cims201.spider.grabnews.uggdyj.rule.YJUrlRule;
 ...
 * 
 */
public class YJSpider extends Thread implements ISpiderReportable {
	private static final YJSpider m_bzwspider = new YJSpider();
	
	private Log log = LogFactory.getLog(this.getClass().getName());

	protected Spider _spider = null;

	protected static String _hostUrl = "http://www.uggd.com/news/yjnews/";
...
//			); 
	...
	protected YJUrlRule rule = new YJUrlRule();
	protected ParserYJ parser = new ParserYJ();
	private static String spidername = "BzwSpider";

	private static String tablename = "workload";

	private static String urlpattern = "http://www.uggd.com/news/yjnews/\\d{4}-\\d{2}-\\d{2}/\\d{5}.html";

//	private static String defaulturl = "http://www.bzw.com.cn/article/class_other.asp?id=89&page=";
	private static String defaulturl = "http://www.uggd.com/news/yjnews/";  
	...
	public static YJSpider getInstance() {
		return m_bzwspider;
	}
	/*
	 * （非 Javadoc）
