package edu.zju.cims201.spider.grabnews.uggdyj.parser;
...
public class ParserYJ implements edu.zju.cims201.spider.commontool.Parser{
    private String source;
    private Log log = LogFactory.getLog(this.getClass());
	public ParserYJ(){
    	
    }
    public ParserYJ(String source){
    	this.source = source;
    }
