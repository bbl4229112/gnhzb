package edu.zju.cims201.spider.grabnews.uggdzh.parser;
...
public class ParserZH implements edu.zju.cims201.spider.commontool.Parser{
    private String source;
    private Log log = LogFactory.getLog(this.getClass());
	public ParserZH(){
    	
    }
    public ParserZH(String source){
    	this.source = source;
    }
...
//        else{
    	...
    	String close = "<div class=\"newspage\"></div>";
    	summary = StringUtils.substringBetween(this.source, open, close);       	
//        }	
		//去掉标签里面的样式
