package edu.zju.cims201.spider.heaton.bot.catbot;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;

import edu.zju.cims201.spider.heaton.bot.*;
...
abstract public class Recognize
{
  ...
  public boolean perform(HTMLPage page)
  {
    ...
    {
        log.error("CatBot IO exception during perform:",e);
    	//Log.logException("CatBot IO exception during perform:",e);
      return false;
    }
    catch(javax.swing.text.BadLocationException e)
    {
        log.error("CatBot HTML Parse exception during perform:",e);
      return false;
    }
  }
