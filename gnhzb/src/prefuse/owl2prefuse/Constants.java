...
public final class Constants
{
     ...
     */
    public final static int NODE_COLOR_CLASS = ColorLib.rgb(240,240,255);//ColorLib.rgb(253, 211, 100);
    
    /**知识实例
     * The color of nodes in the Prefuse visualization which represent OWL Individuals.
     */
    public final static int NODE_COLOR_INDIVIDUAL =ColorLib.rgb(173,173,255);//ColorLib.rgb(0, 255, 255); //ColorLib.rgb(220, 70, 217);
    
    /** 选中的节点
     * The color of selected nodes in the Prefuse visualization.
     */
    public final static int NODE_COLOR_SELECTED = ColorLib.rgb(253,101,130);
    
    /**节点路径
     * The color of highlighted nodes in the Prefuse visualization.
     */
    public final static int NODE_COLOR_HIGHLIGHTED = ColorLib.rgb(243,209,215);//ColorLib.rgb(144, 253, 126);
    
    /**查询结果节点
     * The color of nodes in the keyword search resultset in the Prefuse visualization.
     */
    public final static int NODE_COLOR_SEARCH =ColorLib.rgb(255,190,190); //ColorLib.rgb(255,190,190);
    
    /**关系节点,词类
     * The default color for nodes (if nothing else applies).
     */
    public final static int NODE_DEFAULT_COLOR =ColorLib.rgb(250,240,255); //ColorLib.rgb(200, 200, 255);
