...
/**
 * This class is the super class of specific converter classes. <p/> Project
 * OWL2Prefuse <br/> Converter.java created 2 januari 2007, 10:41 <p/> Copyright
 * &copy 2006 Jethro Borsje
 * 
 * @author <a href="mailto:info@jborsje.nl">Jethro Borsje</a>
 * @version $$Revision: 1.2 $$, $$Date: 2009/09/22 12:42:28 $$
 */
public class Converter {
	...
	public Converter(String p_OWLFile) {
		//load(p_OWLFile);
		m_model=ModelFlyWeightFactory.getInstance().getModel(p_OWLFile);
