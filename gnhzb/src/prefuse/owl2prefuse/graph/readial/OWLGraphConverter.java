package prefuse.owl2prefuse.graph.readial;
...
import prefuse.owl2prefuse.graph.readial.Converter;
...
//        m_graph.getNodeTable().addColumn("image", String.class);
    ...
    {
    	String imgUrl= "http://zzh:8080/MapleTr/Image/map/" ;
		String[] images = new String[20];
		images[0]=imgUrl+ "s.gif";
		for (int i = 1; i < 20; i++)
		{	
       ...
       // currNode.setString("image", images[9]);
...
//						tt++;
//					}
//					target.setString("image", types.get(strEdge[1]).toString());
//				}
//				else{
