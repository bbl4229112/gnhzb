...
/**
 * This class represents a graph in a JPanel. <p/> Project OWL2Prefuse <br/>
 * GraphPanel.java created 3 januari 2007, 11:47 <p/> Copyright &copy 2006
 * Jethro Borsje
 * 
 * @author <a href="mailto:info@jborsje.nl">Jethro Borsje</a>
 * @version $$Revision: 1.3 $$, $$Date: 2009/10/09 02:54:08 $$
 */
public class relationGraphPanel extends JPanel implements ChangeListener,
		ExportableGraphic {
	/**
	 * 
	 */
	 ...
	 */
	private relationGraphDisplay m_display;
	 ...
	 */
	public relationGraphPanel(relationGraphDisplay p_display, boolean p_legend,
...
panel.setSize(180,500);
	...
	private JPanel getHopsWidgets() {
		...
		panel.setBorder(new TitledBorder("距离控制"));
...
//		JEditorPane legend = new JEditorPane("text/html", content);
//		legend.setEditable(false);
//		legend.setBorder(new TitledBorder("知识属性"));
